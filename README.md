...
Простой синтаксис, много функционала записывается в виде функций, используется в веб-разработке.
...
Простой синтаксис, популярен среди новичков, но с плохой репутацией в виде медленной работы. Используется в разработке ИИ, ботов.
...
Синтаксис необычный по сравнению с другими, вид кода строгий. Используется в серверных приложениях.
